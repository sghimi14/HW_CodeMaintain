...
crb = gpd.read_file('/Users/sghimi14/Documents/Research/Analysis_Basin_Shapefiles/basin_CRB_poly.shp')
crb = crb.to_crs('epsg:4326')

lower = gpd.read_file('/Users/sghimi14/Documents/Research/Analysis_Basin_Shapefiles/basin_LowerBasin_poly.shp')
lower = lower.to_crs('epsg:4326')

upper = gpd.read_file('/Users/sghimi14/Documents/Research/Analysis_Basin_Shapefiles/basin_UpperBasin_poly.shp')
upper = upper.to_crs('epsg:4326')
...
for each in sites_dict:
    station_name = each
    station_info = sites_dict[each]
